...
- **近 6-12 个月内的事件/政策/数据必须独立 WebSearch 验证**：即使草稿给出了看似具体的说法（"X 月批准""N 万片""某日禁止"），也要重新搜索确认。原始笔记里"narrative-convenient"（正好契合论点）的事实尤其要警惕。时事话题的事实会在草稿到发文的窗口里改变
- **参考文献抽查**：写完文章后抽查 1-2 条关键参考链接，确认目标页面真的说了正文所说的话。URL 可用不代表内容对得上
